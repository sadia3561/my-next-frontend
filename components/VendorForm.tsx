...
export default function VendorForm() {
  ...
  return (
    ...
    > <div className="pt-24"></div>
      ...
      <textarea name="natureOfBusiness" placeholder="Nature of Business / Products / Services Offered" onChange={handleChange} className="w-full p-2 border rounded"></textarea>
      <input type="text" name="majorClients" placeholder="Major Clients" onChange={handleChange} className="w-full p-2 border rounded" />
      <input type="text" name="aniBusiness" placeholder="Existing Business with ANI (if any)" onChange={handleChange} className="w-full p-2 border rounded" />
      ...
      <input type="text" name="msme" placeholder="MSME / NSIC Registration" onChange={handleChange} className="w-full p-2 border rounded" />
      <input type="text" name="esiPf" placeholder="ESI / PF Registration No." onChange={handleChange} className="w-full p-2 border rounded" />
      <input type="text" name="iso" placeholder="ISO / Quality Certifications" onChange={handleChange} className="w-full p-2 border rounded" />
